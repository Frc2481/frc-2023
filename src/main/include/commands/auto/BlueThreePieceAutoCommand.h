 ...
 */
class BlueThreePieceAutoCommand
    : public frc2::CommandHelper<frc2::SequentialCommandGroup, 
    BlueThreePieceAutoCommand> {
 ...
 public:
  BlueThreePieceAutoCommand(Drivetrain* drive, Elevator* elevator, Flipper* flipper, Gripper* gripper, Intake* intake, Slide* slide){
    m_pDrive = drive;
    ...
    forwardEndConfig.SetStartVelocity(units::velocity::feet_per_second_t(5));
    ...
    reverseEndConfig.SetStartVelocity(units::velocity::feet_per_second_t(5));
